<?php 
  ...
  ?>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control"  name="codproduto" placeholder="Digite o código do produto">
      
    </div>
    <div class="form-group">
      <label for="datacompra">Data da Compra</label>
      <input type="date" class="form-control"  name="datacompra" placeholder="Digite o CPF ou CNPJ"> 
    </div>
    <div class="form-group">
      <label for="tipoproduto">Tipo</label>
    <select class="form-control form-control-lg" name="tipoproduto">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" name="precovenda" placeholder="Digite o preço de venda">
    </div>
