<?php 
  ...
  <h1  style="text-align: center;">Alteração de Clientes</h1> 
    ...
    <input type="hidden" name="idcliente" value="<?=$clientes['idcliente']?>">
      ...
      <input type="text" class="form-control" name="nomefantasia" value="<?=$clientes['nomefantasia']?>">
      
    </div>
    <div class="form-group">
      <label for="razaosocial">Razão Social</label>
      <input type="text" class="form-control"  name="razaosocial" value="<?=$clientes['razaosocial']?>">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control"  name="cpf_cnpj" value="<?=$clientes['cpf_cnpj']?>"> 
    </div>
    <div class="form-group">
